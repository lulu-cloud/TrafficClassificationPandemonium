...
# Add default JVM options here. You can also use JAVA_OPTS and CFM_OPTS to pass JVM options to this script.
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $CFM_OPTS -classpath "\"$CLASSPATH\"" cic.cs.unb.ca.ifm.Cmd "$APP_ARGS"
